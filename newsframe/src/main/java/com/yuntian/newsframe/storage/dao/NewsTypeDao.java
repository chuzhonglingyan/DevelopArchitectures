package com.yuntian.newsframe.storage.dao;

import android.content.Context;

import com.yuntian.baselibs.util.AssetsHelper;
import com.yuntian.baselibs.util.GsonUtil;
import com.yuntian.newsframe.storage.table.DaoSession;
import com.yuntian.newsframe.storage.table.NewsTypeInfo;
import com.yuntian.newsframe.storage.table.NewsTypeInfoDao;
...
public class NewsTypeDao {
    ...
    public static void updateLocalData(Context context, DaoSession daoSession) {
        sAllChannels = GsonUtil.jsonToList(AssetsHelper.readData(context, "NewsChannel"), NewsTypeInfo.class);
