package com.yuntian.newsframe.ui.news.bean;

import android.os.Parcel;
import android.os.Parcelable;

import com.yuntian.adapterlib.base.TypeInterface;
import com.yuntian.newsframe.util.TextUtils;
 ...
 */
public class NewsBean implements Parcelable,TypeInterface {
    ...
    public String getSource() {
        return TextUtils.clipNewsSource(source);
    }
    ...
    public int getViewType() {
        return ViewHolderUtil.getViewType(this.getClass(),type);
    }
