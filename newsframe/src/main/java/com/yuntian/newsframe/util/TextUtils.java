...
public class TextUtils {
    ...
    public static String clipPhotoSetId(String photoId) {
        if (android.text.TextUtils.isEmpty(photoId)) {
            return photoId;
        }
    ...
    public static String replaceFilePath(String filePath) {
        ...
        if (filePath.startsWith("/sdcard") && SDCardUtils.getSDCardPathByEnvironment()!= null) {
            filePath = filePath.replaceFirst("/sdcard", SDCardUtils.getSDCardPathByEnvironment());
